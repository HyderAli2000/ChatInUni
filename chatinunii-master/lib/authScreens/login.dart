...
class _LoginState extends State<Login> {
  ...
  void initState() {
    ...
    translator
        .translate("you logged in as", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        loginas = value;
      });
    ...
    translator
        .translate("Login", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        login = value;
      });
    ...
    translator
        .translate("UserName", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        name = value;
      });
    ...
    translator
        .translate("Password", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        pass = value;
      });
    ...
    translator
        .translate("Forget Password", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        forgetpass = value;
      });
    ...
    translator
        .translate("Click here ", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        clickhere = value;
      });
    ...
    translator
        .translate("Signup", from: 'en', to: '${lang!.split('-')[0]}')
        .then((value) {
      setState(() {
        signUp = value;
      });
